...
class ObjectUtils {
    ...
    public static void writeBytes(Object vo, com.rst.cgi.common.utils.ByteBuffer bf) {
        ...
        for (String key : params.keySet()) {
            ...
            if (obj instanceof BaseVo || obj instanceof List || obj instanceof Map) {
                if ("authorization".equals(key)) {
                    ...
                    com.rst.cgi.common.utils.ByteBuffer databf = new com.rst.cgi.common.utils.ByteBuffer();
